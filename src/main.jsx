  ...
  return (
    <main style={{
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <p style={{ color: "#5eead4", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700 }}>
          Easy Emissions Marketing Console v1
        </p>

        <h1 style={{ fontSize: "clamp(40px, 8vw, 84px)", lineHeight: 1, margin: "18px 0" }}>
          Get more cars through the doors.
        </h1>

        <p style={{ fontSize: "22px", color: "#cbd5e1", maxWidth: "760px" }}>
